...
Cohort 2024A had the highest average pre-work score (81.8). This suggests that this cohort may have entered the program with slightly stronger foundational knowledge.
...
There are 8 students who scored 80 or above. Most are from Jordan, with a few from Palestine and one from Egypt.
...
Lina Barakat submitted all listed projects on time with very high grades (98, 95, 96), which indicates consistent performance and strong engagement.